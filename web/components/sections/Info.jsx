...
const info = {
  ...
  par1: "Kom op zaterdag 19 april 2025 naar het Rapenburg in Leiden en geniet van de eerste editie van de EENDENRACE Leiden. Er is muziek, entertainment voor de kinderen en voldoende horeca om van te genieten tijdens de race.",
  par2: "Adopteer jouw eenden en steun ons goede doel én maak kans op	schitterende prijzen.",
  par3: "Een eend adopteren kan al vanaf € 5.",
};
